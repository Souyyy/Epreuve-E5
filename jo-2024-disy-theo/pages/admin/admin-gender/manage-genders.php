    ...
    <main>
        ...
        try {
            ...
            if ($statement->rowCount() > 0) {
                echo "<table><tr><th>ID</th><th>Genre</th><th>Action</th></tr>";
                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td> <button onclick='openModifyGenderForm({$row['id_genre']})'>Modifier</button> <button onclick='deleteGenderConfirmation({$row['id_genre']})'>Supprimer</button></td>";
                    echo "</tr>";
                }
